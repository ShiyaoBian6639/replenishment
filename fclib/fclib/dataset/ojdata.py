...
def split_train_test(data_dir, n_splits=1, horizon=2, gap=2, first_week=40, last_week=275, write_csv=False):
    ...
    sales = pd.read_csv(os.path.join(data_dir, "yx_modified.csv"), index_col=0)
